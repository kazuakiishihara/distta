...
https://github.com/TVayne/GroupMorph.git

Original paper:
Zuopeng Tan, Lihe Zhang, Yanan Lv, Yili Ma, and Huchuan Lu.
GroupMorph: Medical Image Registration via Grouping Network With Contextual Fusion.
...
class GroupMorph(nn.Module):
    ...
    def __init__(self, in_ch, basic_channel=8, imgshape=(160, 192, 192), groups=(4, 2, 2)):
        super(GroupMorph, self).__init__()
...
if __name__ == "__main__":
    ...
    y = y.cuda().float()
    model = GroupMorph(1, 8).cuda()
    flop, para = profile(model, inputs=(y,y,))  # 必须加上逗号，否者会报错
